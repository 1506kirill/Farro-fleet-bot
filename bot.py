...
def rebuild_fleet_graphs(
    ...
    # Expenses by vehicle for the last 180 calendar days.
    # Read directly from each vehicle snapshot: E = expense date, I = expense USD.
    ...
    for car_id in KNOWN_CAR_IDS:
        ...
        for row in car_rows[7:]:
            ...
            if (
                expense_date
                and expense_usd is not None
                and expense_180_start <= expense_date <= today
            ):
