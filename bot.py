...
def rebuild_fleet_graphs(monthly_data=None) -> str:
    ...
    graphs_ws.update("A1", fleet_rows, value_input_option="USER_ENTERED")
    graphs_ws.update("F1", current_rows, value_input_option="USER_ENTERED")
